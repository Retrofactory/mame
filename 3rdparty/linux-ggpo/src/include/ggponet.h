 ...
 */
GGPO_API GGPOErrorCode GGPO_CDECL ggpo_start_session(GGPOSession **session,
 ...
 */
GGPO_API GGPOErrorCode GGPO_CDECL ggpo_add_player(GGPOSession *session,
                                               GGPOPlayer *player,
 ...
 *
 */
GGPO_API GGPOErrorCode GGPO_CDECL ggpo_start_synctest(GGPOSession **session,
                                                   GGPOSessionCallbacks *cb,
                                                   char *game,
                                                   int num_players,
                                                   int input_size,
 ...
 */
GGPO_API GGPOErrorCode GGPO_CDECL ggpo_start_spectating(GGPOSession **session,
                                                     GGPOSessionCallbacks *cb,
                                                     const char *game,
                                                     int num_players,
                                                     int input_size,
 ...
 */
GGPO_API GGPOErrorCode GGPO_CDECL ggpo_close_session(GGPOSession *);
 ...
 */
GGPO_API GGPOErrorCode GGPO_CDECL ggpo_set_frame_delay(GGPOSession *,
                                                    GGPOPlayerHandle player,
                                                    int frame_delay);
 ...
 * in milliseconds.
 */
GGPO_API GGPOErrorCode GGPO_CDECL ggpo_idle(GGPOSession *,
                                         int timeout);
 ...
 */
GGPO_API GGPOErrorCode GGPO_CDECL ggpo_add_local_input(GGPOSession *,
                                                    GGPOPlayerHandle player,
                                                    void *values,
                                                    int size);
 ...
 */
GGPO_API GGPOErrorCode GGPO_CDECL ggpo_synchronize_input(GGPOSession *,
                                                      void *values,
                                                      int size,
 ...
 */
GGPO_API GGPOErrorCode GGPO_CDECL ggpo_disconnect_player(GGPOSession *,
                                                      GGPOPlayerHandle player);
 ...
 */
GGPO_API GGPOErrorCode GGPO_CDECL ggpo_advance_frame(GGPOSession *);
 ...
 */
GGPO_API GGPOErrorCode GGPO_CDECL ggpo_get_network_stats(GGPOSession *,
                                                      GGPOPlayerHandle player,
 ...
 */
GGPO_API GGPOErrorCode GGPO_CDECL ggpo_set_disconnect_timeout(GGPOSession *,
                                                           int timeout);
 ...
 */
GGPO_API GGPOErrorCode GGPO_CDECL ggpo_set_disconnect_notify_start(GGPOSession *,
                                                                int timeout);
 ...
 * SDK.
 */
GGPO_API void GGPO_CDECL ggpo_log(GGPOSession *,
                               const char *fmt, ...);
/*
 * ggpo_logv --
 *
 ...
 * more details.
 */
GGPO_API void GGPO_CDECL ggpo_logv(GGPOSession *,
                                const char *fmt,
                                va_list args);
